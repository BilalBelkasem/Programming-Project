  ...
  -- NOTE: Speeddate functionality is in 'speeddates_database.sql'
  ...
  (1, 1, 3, '2025-06-05 09:06:39', 0),
  (2, 2, 4, '2025-06-05 09:06:39', 0),
  (36, 13, 4, '2025-06-19 15:16:03', 0),
  ...
  (1, 1, 'Hogeschool Gent', 'Toegepaste Informatica', 'derde', 'Passie voor software development.', 'https://linkedin.com/in/alice', 1, 1, 1, 0, 0, 0, 0, 0),
  (2, 2, 'Hogeschool Gent', 'Toegepaste Informatica', 'tweede', 'Grote interesse in AI en data.', 'https://linkedin.com/in/thomas', 0, 1, 1, 1, 0, 0, 0, 0),
  (4, 8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  (6, 11, 'ErasmusHogeschool', 'TI', '', 'Ik ben Bilal', 'https://www.linkedin.com/in/bilal-belkasem-0ba8552b6/', 1, 0, 0, 0, 0, 0, 0, 0),
  (7, 13, 'Erasmus Hogeschool Brussel', 'toegepaste informatica', 'eerste', ':sfhlghse', NULL, 0, 0, 0, 1, 0, 0, 0, 0);
  ...
  CREATE TABLE `users` (
    ...
    `role` enum('student','bedrijf','admin') NOT NULL DEFAULT 'student',
  ...
  INSERT INTO `users` (`id`, `name`, `email`, `password_hash`, `role`, `organization`, `profile_slug`, `created_at`, `updated_at`) VALUES
  (1, 'Alice Student', 'alice@student.com', '$2b$10$mstei6sypy6fdgdUHNHDIeo/aXAiE9LL/BKAPv0H5OK82U73ZfTn2', 'student', 'Hogeschool Gent', 'alice-student', '2025-06-05 09:01:00', '2025-06-05 09:01:00'),
  (2, 'Thomas Student', 'thomas@student.com', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'student', 'Hogeschool Gent', 'thomas-student', '2025-06-05 09:01:00', '2025-06-05 09:01:00'),
  (3, 'Bob Company', 'bob@bedrijf.com', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'bedrijf', 'TechCorp', 'bob-company', '2025-06-05 09:01:00', '2025-06-05 09:01:00'),
  (4, 'Eva Enterprise', 'eva@bedrijf.com', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'bedrijf', 'SmartSolutions', 'eva-enterprise', '2025-06-05 09:01:00', '2025-06-05 09:01:00'),
  (5, 'Admin Beheer', 'admin@careerlaunch.be', '$2b$10$yd6ZQbXM3QBC.uNfz2apBulLeqIiEb78ss.C7wIbxTzC4xLa5pd2S', 'admin', NULL, NULL, '2025-06-05 09:01:00', '2025-06-05 09:01:00'),
  (8, 'Digay kengoum', 'Digay.kengoum@student.ehb.be', '$2b$10$OSWeRWMn6mJSlZP//.BdOOXGBdP5h.tUxHQ9W7bUzw86JXpx5jVHG', 'student', NULL, NULL, '2025-06-13 13:22:59', '2025-06-13 13:22:59'),
  (10, 'âzerty', 'azerty@azerty', '$2b$10$INqhpWp9K8hGxIDmzeH5tOXWrGavD85GVPKwLnFRamoA7Oy1sT9ra', 'bedrijf', NULL, NULL, '2025-06-16 07:52:30', '2025-06-16 07:52:30'),
  (11, 'Bilal Belkasem', 'bilal.belkasem@student.ehb.be', '$2b$10$1Vt9y9nSEVWMOe98nDCoxOCc3/EQx/JHIY3HRmj9MGDEq05H4Zod6', 'student', NULL, NULL, '2025-06-17 07:49:01', '2025-06-17 07:49:01'),
  (12, 'qwerty', 'qwerty@qwerty', '$2b$10$9dPSkl6VbWAdFgSWJ0eXHeaYs.HXMhRFhNhuIcugyFHW7caemhgGK', 'bedrijf', NULL, NULL, '2025-06-17 08:22:02', '2025-06-17 08:22:02'),
  (13, 'jelle schroeven2', 'jelle.schroeven@student.ehb.be', '$2b$10$akFfsQZpQNEk2aO88uSIf.y7UPqGn6Ys7u7/fLnxGoxG0Q6wS3Lxq', 'student', NULL, NULL, '2025-06-18 08:05:22', '2025-06-18 08:05:22');
  ...
  --
  ALTER TABLE `likes`
    ADD PRIMARY KEY (`User_ID`,`ID_target`);
  ...
  --
  ALTER TABLE `companies_details`
    ADD CONSTRAINT `companies_details_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
  ...
  ALTER TABLE `favorites`
    ...
    ADD CONSTRAINT `favorites_ibfk_2` FOREIGN KEY (`company_id`) REFERENCES `companies_details` (`user_id`) ON DELETE CASCADE;

  --
  -- Constraints for table `feedback`
  --
  ALTER TABLE `feedback`
    ADD CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `companies_details` (`id`) ON DELETE CASCADE,
    ADD CONSTRAINT `feedback_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `students_details` (`id`) ON DELETE CASCADE;

  --
  -- Constraints for table `stands`
  --
  ALTER TABLE `stands`
    ADD CONSTRAINT `stands_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `companies_details` (`id`) ON DELETE CASCADE;

  --
  -- Constraints for table `students_details`
  --
  ALTER TABLE `students_details`
    ADD CONSTRAINT `students_details_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
